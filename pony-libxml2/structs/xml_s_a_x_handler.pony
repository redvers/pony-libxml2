/*
  Source: /usr/include/libxml2/libxml/parser.h:721
...
struct XmlSAXHandler
  ...
  var _startElementNs: Pointer[None] = Pointer[None]
  var _endElementNs: Pointer[None] = Pointer[None]
  var _serror: Pointer[None] = Pointer[None]
